...
class CompleteAPIRailwayCalculator:
    ...
    def init_default_stations(self):
        ...
        default_stations = [
            ...
            # Additional station mappings - User provided list
            ("KQG", "KARGIL", "NR"),
            ("MFP", "MUIRPUR ROAD", "NR"),
            ("CCT", "KATWA", "ER"),
            ("YA", "ALLAPALLI", "SECR"),
            ...
            ("MLDR", "MALDARE", "CR"),
            ("KRNT", "KARANIT", "WR"),
            ("STA", "SATNA JUNCTION", "WCR"),
            ("KGI", "KHARAGPUR", "SER"),
            ("LMG", "LAMANI", "SWR"),
            ("ANGL", "ANGUL", "ECoR"),
            ("HWHH", "HOWRAH JUNCTION", "ER"),
            ("SRE", "SAHARANPUR", "NR"),
            ("EE", "ELURU", "SCR"),
            ("KARWAR", "KARWAR", "KR"),
            ("MLDT", "MALKHAID ROAD", "SCR"),
            ("ANGUL", "ANGUL", "ECoR"),
            ("DMV", "DAMOH", "WCR"),
            ("NBQ", "NAVABAZAR", "NFR"),
            ("KOJ", "KEONJHAR", "ECoR"),
            ...
            ("SGR", "SIROHI ROAD", "NWR"),
            ("SDAH", "SADAR BAZAR", "NR"),
            ("SCL", "SECUNDERABAD", "SCR"),
            ("SBP", "SABARMATI", "WR"),
            ("LLT", "LALITPUR", "NCR"),
            ("BKMI", "BIKRAMGANJ", "ECR"),
            ("NKP", "NAGPUR", "SECR"),
            ("LTT", "LAL TOKI TALA", "ER"),
            ("SCB", "SAMBALPUR", "ECoR"),
            ("HADS", "HINDUSTHAN STATION", "NCR"),
            ("NHLN", "NILAMBUR ROAD", "SR"),
            ("KYTM", "KUYYAMTHALAM", "SR"),
            ("SHM", "SAHNEWAL", "NR"),
            ("DGR", "DURG", "SECR"),
            ("THE", "THANE", "CR"),
            ("NSK", "NARASAPUR", "SCR"),
            ...
            ("USL", "USLAPUR", "SCR"),
            ("TIR", "TIRUPATI", "SCR"),
            ("CLT", "CALCUTTA TOWN", "ER"),
            ("BSP", "BHILAI POWER HOUSE", "SECR"),
            ("UMB", "AMBALA CANTT", "NR"),
            ("PRR", "PARBHANI ROAD", "SCR"),
            ("HTE", "HAZARIBAGH ROAD", "ECR"),
            ("LKR", "LUCKNOW CHARBAGH", "NR"),
            ("ASN", "ASANSOL", "ER"),
            ("SRTL", "SHRI MATHURAPUR HALT", "ER"),
            ("NTSK", "NATSINGH", "NFR"),
            ("AWT", "AWANTIPUR", "NR"),
            ("RPAN", "RUPANPURA", "WR"),
            ("VG", "VIJAYAWADA", "SCR"),
            ...
            ("AGTL", "AGARTALA", "NFR"),
            ("BRPD", "BARPETA ROAD", "NFR"),
            ("PNBE", "PATNA JUNCTION", "ECR"),  # Corrected from user's "PUNE JUNCTION"
            ("MLDT", "MALDA TOWN", "NFR")  # Corrected mapping
        ]
